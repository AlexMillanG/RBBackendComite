...
@Tag(name = "Controlador de Event Type" , description = "Operaciones realizadas con el tipo de evento")
...
public class eventTypeController {
    ...
    @GetMapping
    @Operation(summary = "Obtencion de un solo tipo de evento", description = "Mandar a traer todos los tipos de eventos registrados en el sistema.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Obtencion de todos los tipos de evento",
                    content = {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Obtencion de un solo tipo de evento", description = "Mandar a traer un solo tipo de evento con uso del id dentro del sistema.")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Obtencion de un solo tipo de evento",
                    content = {
                            @Content(mediaType = "application/json", schema = @Schema(implementation = APIResponse.class)),
                            @Content(mediaType = "application/xml", schema = @Schema(implementation = APIResponse.class))
            ...
            @ApiResponse(
                    responseCode = "404",
                    description = "No se logro encontrar el tipo de evento",
                    content = {
                            @Content(mediaType = "application/json", schema = @Schema(implementation = APIResponse.class)),
                            @Content(mediaType = "application/xml", schema = @Schema(implementation = APIResponse.class))
            ...
            @ApiResponse(
                    responseCode = "500",
                    description = "No se pudo consultar el tipo evento",
                    content = {
                            @Content(mediaType = "application/json", schema = @Schema(implementation = APIResponse.class)),
                            @Content(mediaType = "application/xml", schema = @Schema(implementation = APIResponse.class))
